...
//                .incomer11kVFeederId(createdFeederAvroModel.getIncomer11kVFeederId())
//                .feedingPTRId(createdFeederAvroModel.getFeedingPTRId())
//                .feeding33kVFeederId(createdFeederAvroModel.getFeeding33kVFeederId())
//                .isCharged(createdFeederAvroModel.getIsCharged())
//                .isLoaded(createdFeederAvroModel.getIsLoaded())
//                .build();
//    }
//}
